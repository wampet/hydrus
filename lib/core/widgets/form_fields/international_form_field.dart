...
class CustomInternationalFormField extends StatefulWidget {
  ...
  @override
  State<CustomInternationalFormField> createState() =>
      _CustomInternationalFormFieldState();
}

class _CustomInternationalFormFieldState
    extends State<CustomInternationalFormField> {
  @override
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: IntlPhoneField(
          ...
          flagsButtonMargin:
              EdgeInsets.symmetric(horizontal: getVerticalSize(20)),
